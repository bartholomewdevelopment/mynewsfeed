...
const DEFAULT_SOURCES = [
  ...
  },
  {
    ...
    includeKeywords: [],
    excludeKeywords: [
      'festival', 'fair', 'raffle', 'donation', 'donated', 'award', 'awards',
      'art show', 'fundraiser', 'fundraising', 'scholarship', 'entertainment',
      'concert', 'exhibit', 'showcase', 'ribbon cutting', 'honor flight',
      'science fair', 'achievement dinner', 'chamber banquet', 'pageant',
      'baseball', 'softball', 'basketball', 'football', 'golf tournament',
      'strider bike', 'steampunk', 'community theater', 'quilt show',
    ],
    notes: 'Hyperlocal Gallia/Meigs/Mason — blocks community fluff, keeps emergencies and safety.',
  },
  {
